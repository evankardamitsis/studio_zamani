...
export default function ContactPage() {
  return (
    <div className="h-full xl:min-h-screen bg-[#f8f8f2] flex flex-col xl:flex-row overflow-hidden">
      {/* Image — top aligns with logo, bottom aligns with Contact in the sidebar */}
      <div className="w-full h-[34vh] md:h-[40vh] xl:aspect-auto xl:w-[70%] xl:h-screen overflow-hidden bg-[#f8f8f2] p-4 xl:pl-10 xl:pr-10 xl:pt-10 xl:pb-16">
      ...
      {/* Info — bottom aligned */}
      <div className="w-full flex-1 min-h-0 xl:w-[30%] xl:h-screen flex flex-col px-6 pt-4 pb-4 xl:px-10 xl:pt-10 xl:pb-16">
        <div className="flex-1 flex flex-col justify-start gap-12 xl:justify-end xl:gap-10">
          {/* Email */}
        ...
        <div className="hidden xl:flex flex-wrap items-center gap-x-4 gap-y-1 pt-10">
