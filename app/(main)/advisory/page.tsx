...
export default function AdvisoryPage() {
  return (
    <div className="md:h-screen md:overflow-hidden bg-[#f6f8f8] flex flex-col md:flex-row">
      {/* Image */}
      ...
      {/* Copy */}
      <div className="w-full md:w-[60%] md:h-screen flex flex-col justify-center px-6 py-8 md:px-14">
