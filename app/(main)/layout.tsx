  ...
  return (
    <>
      ...
      <div className="flex min-h-screen">
        <Sidebar />
        <main className="flex-1 min-w-0 pt-[56px] md:pt-0 md:pl-[166px] pb-[48px] md:pb-0">
          {children}
        </main>
      </div>
      {/* Mobile footer */}
      <footer className="md:hidden fixed bottom-0 left-0 right-0 z-30 flex items-center justify-between px-6 border-t border-[#242020]/10"
              style={{ backgroundColor: "#f6f8f8", height: 48 }}>
